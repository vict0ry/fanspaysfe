      ...
      <Card sx={{ maxWidth: '1fr', width: { md: '590px', xs: '390px' }, gridColumn: 'unset' }}>
        ...
        <CardContent>
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: { md: '1fr 1fr 1fr', xs: '1fr 1fr' }, gap: 2 }}>
            <InfoIcon afterIcon={'srpen 2021'} icon={'/images/icons/calendar.svg'}
                      title={t('PROFILE.USER_FIRST_REGISTERED')}></InfoIcon>
            <InfoIcon afterIcon={'Praha'} icon={'/images/icons/map-pin.svg'} title={t('Location')}></InfoIcon>
            <InfoIcon afterIcon={new Date(parsedDate).toLocaleDateString('cs-CZ')} icon={'/images/icons/gift.svg'}
                      title={t('PROFILE.BIRTH_DATE')}></InfoIcon>
            <InfoIcon afterIcon={t(getZodiac(parsedDay, parsedMonth))} icon={'/images/icons/zodiac-aries.svg'}
                      title={t('PROFILE.ZODIAC')}></InfoIcon>
            <InfoIcon afterIcon={t('10 minutes')} icon={'/images/icons/time.svg'}
                      title={t('COMMON.LAST_ACTIVE')}></InfoIcon>
