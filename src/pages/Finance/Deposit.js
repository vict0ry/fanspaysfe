          ...
          <Box sx={{
            ...
            <Button
              sx={{
                ...
                ...{ border: depositMethod === 0 ? '2px solid #4b75e7' : '1px solid #ece9f1' }
              }}
              onClick={() => {
                setDepositMethod(0)
              }}
            ...
            <Button
              sx={{
                ...
                ...{ border: depositMethod === 1 ? '2px solid #4b75e7' : '1px solid #ece9f1' }
              }}
              onClick={() => {
                setDepositMethod(1)
              }}
            ...
            <Button
              sx={{
                ...
                ...{ border: depositMethod === 2 ? '2px solid #4b75e7' : '1px solid #ece9f1' }
              }}
              onClick={() => {
                setDepositMethod(2)
              }}
