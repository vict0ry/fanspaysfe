    ...
    >
      ...
      <div key={id}
        ...
        <div ref={messageInfo} style={{ ...stylesMessage.messageInfo }}>
          <div
            style={stylesMessage.nameAuthor}>{isSender(i) ? 'Вы' : i.sender.firstName + ' ' + i.sender.lastName}</div>
        ...
        <div ref={message}
             style={{ ...stylesMessage.message, ...isSender(i) ? stylesMessage.myMessage : stylesMessage.anotherMessage }}>
          {i.product ? <div>
