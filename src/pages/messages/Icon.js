...
export const Icon = ({name, color}) => {
    ...
    switch(name){
        ...
        case "circle_forbid": 
            image =
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="8" cy="8" r="6" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M5.66663 5.66602L10.3333 10.3327" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            break;
        case "deactivate":
            image =
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14.2992 3.04883L16.9508 5.70048" stroke="#E64747" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M16.9508 3.04883L14.2992 5.70048" stroke="#E64747" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M14.6915 9.23303C14.3573 10.1354 13.7696 10.9221 12.9991 11.4987C12.2286 12.0752 11.3081 12.417 10.348 12.483C9.38797 12.549 8.42929 12.3364 7.58713 11.8708C6.74498 11.4052 6.05517 10.7063 5.60058 9.85813C5.14599 9.00997 4.94595 8.04859 5.02449 7.0895C5.10303 6.1304 5.45682 5.21438 6.04334 4.45148C6.62987 3.68857 7.42419 3.11124 8.33088 2.78883C9.23757 2.46642 10.2181 2.41265 11.1546 2.63397" stroke="#E64747" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M2.5 16.6665C3.26039 15.3997 4.35376 14.3477 5.67025 13.6163C6.98675 12.885 8.48002 12.5 10 12.5C11.5201 12.5 13.0133 12.8851 14.3298 13.6164C15.6463 14.3478 16.7396 15.3998 17.5 16.6667" stroke="#E64747" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            break;
        case "bank_card":
            image =
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21 4H3V20H21V4Z" stroke="#5D5E65" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M3 10H21" stroke="#5D5E65" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M17 16H15" stroke="#5D5E65" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            break;
        case "user": 
            image =
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 15C15.3137 15 18 12.3137 18 9C18 5.68629 15.3137 3 12 3C8.68629 3 6 5.68629 6 9C6 12.3137 8.68629 15 12 15Z" stroke="#5D5E65" strokeWidth="2" strokeMiterlimit="10"/>
